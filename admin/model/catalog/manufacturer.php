...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "',description = '" . $this->db->escape($data['description']) . "', keyword = '" . $this->db->escape($data['keyword']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
...
//		}
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "',description = '" . $this->db->escape($data['description']) . "', keyword = '" . $this->db->escape($data['keyword']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
