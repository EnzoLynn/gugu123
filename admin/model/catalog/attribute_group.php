...
class ModelCatalogAttributeGroup extends Model {
	...
	public function getAttributeGroups($data = array()) {
		$sql = "SELECT *, (SELECT COUNT(attribute_id) FROM gu_attribute WHERE attribute_group_id=ag.attribute_group_id) AS attribute_num FROM " . DB_PREFIX . "attribute_group ag LEFT JOIN " . DB_PREFIX . "attribute_group_description agd ON (ag.attribute_group_id = agd.attribute_group_id) WHERE agd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
