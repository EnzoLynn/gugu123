	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['attribute_groups'][] = array(
				...
				'name'               => $result['name'],
                'attribute_num'     => $result['attribute_num'],
				'sort_order'         => $result['sort_order'],
                'add_attribute'               => $this->url->link('catalog/attribute/add', 'token=' . $this->session->data['token'] . '&attribute_group_id=' . $result['attribute_group_id'] . $url, 'SSL'),
                'list_attribute'               => $this->url->link('catalog/attribute', 'token=' . $this->session->data['token'] . '&attribute_group_id=' . $result['attribute_group_id'] . $url, 'SSL'),
        ...
        $data['button_attribute_list'] = $this->language->get('button_attribute_list');
