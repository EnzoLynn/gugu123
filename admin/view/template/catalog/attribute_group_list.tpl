            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'agd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php echo $column_attribute_num;?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right">
                      <a href="<?php echo $attribute_group['list_attribute']; ?>" data-toggle="tooltip" title="<?php echo $button_attribute_list; ?>" class="text-muted">
                        <?php echo $attribute_group['attribute_num']; ?>
                      </a>
                  </td>
                  <td class="text-right"><?php echo $attribute_group['sort_order']; ?></td>
                  <td class="text-right">
                      <a href="<?php echo $attribute_group['add_attribute']; ?>" data-toggle="tooltip" title="<?php echo $button_attribute_add; ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
                      <a href="<?php echo $attribute_group['list_attribute']; ?>" data-toggle="tooltip" title="<?php echo $button_attribute_list; ?>" class="btn btn-success"><i class="fa fa-list"></i></a>
                      <a href="<?php echo $attribute_group['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
