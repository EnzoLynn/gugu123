            ...
            <div class="tab-pane fade" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="category-filter" class="well well-sm" style="height: 220px; overflow: auto;">
                    <?php foreach ($category_filters as $category_filter) { ?>
                    <div id="category-filter<?php echo $category_filter['filter_id']; ?>" class="col-md-3"><i class="fa fa-minus-circle"></i> <?php echo $category_filter['name']; ?>
...
$('input[name=\'filter\']').autocomplete({
	...
	'select': function(item) {
        ...
        $('#category-filter').append('<div id="category-filter' + item['value'] + '" class="col-xs-3"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="category_filter[]" value="' + item['value'] + '" /></div>');
	}
});
