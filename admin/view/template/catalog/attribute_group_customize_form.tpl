    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-attribute-group-customize" class="form-horizontal">

                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-sort-order"><?php echo $entry_customize_name; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="customize_name" value="<?php echo $customize_info['customize_name']; ?>" placeholder="<?php echo $entry_customize_name; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
