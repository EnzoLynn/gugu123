              ...
              <div class="row">
                  <div class="col-sm-2">
                      <div class="form-group">
                          <select name="filter_attribute_group" id="select-attribute_group" class="form-control">
                              <option value="">--<?php echo $entry_attribute_group; ?>--</option>
...
$().ready(function(){
    $("#select-attribute_group").val("<?php echo $filter_attribute_group_id; ?>");
    $("#select-attribute_group").change(function(){
        if($(this).val() != "") {
            location.href = replaceURLVar("attribute_group_id", $(this).val());
        }
    });
});
</script>
