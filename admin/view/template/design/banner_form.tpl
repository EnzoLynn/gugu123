          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-left" style="width: 10%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][background]" value="<?php echo $banner_image['background']; ?>" placeholder="<?php echo $entry_background; ?>" class="form-control" /></td>
