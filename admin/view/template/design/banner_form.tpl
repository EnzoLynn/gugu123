          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" directory="banner" class="img-thumbnail"><img src="<?php echo $banner_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                ...
                <td class="text-left"><a href="" id="thumb-image2<?php echo $image_row; ?>" data-toggle="image" directory="banner" class="img-thumbnail"><img src="<?php echo $banner_image['thumb2']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
