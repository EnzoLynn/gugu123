...
$_['entry_meta_title'] 	     = 'SEO title';
$_['entry_meta_keyword'] 	 = 'SEO keyword';
$_['entry_meta_description'] = 'SEO description';
$_['entry_keyword']          = '网址关键词';
$_['entry_model']            = '货号';
$_['entry_sku']              = 'SKU';
$_['entry_upc']              = 'UPC';
$_['entry_ean']              = 'EAN';
...
$_['entry_default_option_value'] = '默认选中';
$_['entry_link_product_id']   = '关联商品ID';
$_['entry_quantity']         = '数量';
...
$_['help_master_category']  = '关联的最小分类';
$_['help_category']          = '(输入时自动筛选结果)';
$_['help_filter']            = '(输入筛选组会有提示)';
...
$_['error_model']            = '商品货号必须介于1-64字符之间！';
$_['error_keyword']          = '网址显示的商品关键词格式不对，只能为字符和数字，空格用英文中横线！';