<div class="hidden-xs">
    ...
    <div style="height:150px;overflow: hidden;max-width: 1140px; ">
        <div id="productImgList">
            <a class="fancybox-button" rel="fancybox-button" fancybox-href="../picBase/demo/1_b.jpg" title="cold forest (picturesbywalther)" href="javascript:void(0);">
                <img src="../picBase/demo/1_s.jpg" alt="" />
            </a>
            <a class="fancybox-button" rel="fancybox-button" fancybox-href="../picBase/demo/2_b.jpg" title="Holly blue (Masa_N)">
                <img src="../picBase/demo/2_s.jpg" alt="" />
            </a>
            <a class="fancybox-button" rel="fancybox-button" href="../picBase/demo/3_b.jpg" title="limits (life-and-camera)">
                <img src="../picBase/demo/3_s.jpg" alt="" />
            </a>
            <a class="fancybox-button" rel="fancybox-button" href="../picBase/demo/4_b.jpg" title="*** (fatiguemind)">
                <img src="../picBase/demo/4_s.jpg" alt="" />
            </a>
            <a class="fancybox-button" rel="fancybox-button" href="../picBase/demo/5_b.jpg" title="*** (fatiguemind)">
                <img src="../picBase/demo/5_s.jpg" alt="" />
            </a>
