      ...
      <div class="row">
        ...
        <div class="col-md-30 col-sm-30 col-xs-120">
          <ul class="row">
            ...
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-1.jpg" alt=""></a>
            </li>
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-1.jpg" alt=""></a>
            </li>
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-2.jpg" alt=""></a>
            </li>
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-2.jpg" alt=""></a>
            </li>
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-3.jpg" alt=""></a>
            </li>
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-3.jpg" alt=""></a>
            </li>
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-4.jpg" alt=""></a>
            </li>
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-4.jpg" alt=""></a>
            </li>
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-5.jpg" alt=""></a>
            </li>
            <li class="col-md-50">
              <a href="#"><img src="picBase/pics/brand-5.jpg" alt=""></a>
            </li>
        ...
        <div class="col-md-40 col-sm-50 col-xs-120 logColor">
          <div class="row">
            <div class="col-md-100 col-sm-120">
              <a href="#"><img class="img-responsive" src="picBase/pics/details.jpg"></a>
              <div style="word-wrap:break-word;color:#fff;">sdfasdfasdsafasdfasdfasdfasdfsdfasdfasdsafasdfasdfasdfasdfsdfasdfasdsafasdfasdfasdfasdfsdfasdfasdsafasdfasdfas </div>
              <a href="#"><img class="img-responsive" src="picBase/pics/funer.jpg"></a>
              <div style="word-wrap:break-word;color:#fff;">sdfasdfasdsafasdfasdfasdfasdfsdfasdfasdsafasdfasdfasdfasdfsdfasdfasdsafasd </div>
            </div>
