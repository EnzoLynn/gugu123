...
// Error
$_['error_exists']         = '警告: 邮箱已经被注册！';

$_['error_info']         = '警告: 基本信息有错误！';
$_['error_exists_username'] = '警告: 用户名已经被注册！';
$_['error_exists_email']    = '警告: 邮箱已经被注册！';
$_['error_exists_telephone']= '警告: 手机号已经被注册！';
$_['error_username1']       = '用户名不能为纯数字！';
$_['error_username2']       = '用户名不能包含空格！';
$_['error_username3']       = '用户名必须为 2-32 字符！';
$_['error_fullname']       = '姓名必须为 2-32 字符！';
$_['error_email']          = '邮箱格式不对！';
$_['error_telephone']      = '手机号格式不对！';
